...
| <h4>[#5](https://github.com/chrisluo5311/pythonHomeWork/tree/master/week5) | 單元測試練習，針對以下問題，貼上執行結果 html 報表<br>(1) 安裝 python coverage 套件<br>(2) 針對題目，設計 test case、撰寫 test driver、執行 test driver<br>(3) 達到 branch coverage 100%<br>參考題目:14-2                                                                                                                                                                                                                                                                                         |
